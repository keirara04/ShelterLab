...
export default function SellerProfileError({ error, reset }) {
  useEffect(() => {
    if (process.env.NODE_ENV === 'development') console.error('Seller profile error:', error)
  }, [error])
    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: '#000000' }}>
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-400">This seller profile couldn&apos;t be loaded</p>
        </div>
